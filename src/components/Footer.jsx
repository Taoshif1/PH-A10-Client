  ...
  return (
    <footer className="bg-gradient-to-br from-gray-50 to-gray-100 border-t-4 border-blue-500">
      ...
      <button
        ...
        className="btn btn-circle bg-gradient-to-r from-blue-600 to-purple-600 border-none text-white shadow-lg hover:scale-110 transition-transform fixed bottom-8 right-8 z-50"
      >
